    ...
    <div class="row g-4 justify-content-center">
        <div class="col-lg-4 col-md-6">
            <div class="stats-card">
                ...
                <div class="stats-number" style="color: var(--primary-color);">0</div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="stats-card">
                ...
                <div class="stats-number" style="color: var(--accent-color);">0</div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="stats-card">
                ...
                <div class="stats-number" style="color: var(--warning-color);">0</div>
